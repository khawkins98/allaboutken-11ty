...
| [`ELEVENTY_4_ALPHA_NOTES.md`](ELEVENTY_4_ALPHA_NOTES.md) | Working migration log for the pinned Eleventy 4 alpha, including regressions and upstream-report candidates | Maintainers evaluating the alpha | You are testing, debugging, or deciding whether to keep the Eleventy 4 upgrade |
