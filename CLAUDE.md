...
### Image attribution
For Ken's own photos: use `credit: "Own work."` (not "Photo by Ken Hawkins"). Include location context in the `text` caption, e.g., text: "OneSiam Skywalk, Bangkok.", credit: "Own work."
